...
fastify.get("/fotos", (request, reply) => {
  ...
  //      a. get the json data from other server
  //      b. process that data
  // 3. provide a reply to client
  //      a-2. there was an error, providde a different response
...
fastify.get("/viewfotos/:id", (request, reply) => {
  // #4 TODO:
  // Adapt the following code to attempt to retrieve
  // a single photo from JSONPlaceholder site
  // using fetch, and handle returned Promise using:
